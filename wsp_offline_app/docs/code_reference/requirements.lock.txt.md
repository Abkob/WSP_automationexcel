...
[Open source](../../requirements.lock.txt) · [Code documentation index](../CODE_REFERENCE.md) · [Feature and code flows](../FEATURES_AND_CODE_FLOW.md)
...
1. The application or development workflow loads `requirements.lock.txt` when its requirements.lock.txt responsibility is needed.
