...
function Assert-SourcePayload {
    foreach ($relativePath in @(
        "app", "database", "services", "scripts", "config.py", "main.py",
        "wsp_launcher.pyw", "requirements.txt", "README.md", "version.txt",
...
function Copy-ApplicationPayload {
    ...
    foreach ($relativePath in @(
        ...
        "pyproject.toml", "README.md", "version.txt", "INSTALL_WSP.bat",
        "LAUNCH_WSP.bat", "UPDATE_WSP.bat", "UNINSTALL_WSP.bat"
    )) {
